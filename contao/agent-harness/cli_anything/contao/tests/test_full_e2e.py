"""
E2E tests for cli-anything-contao.
...
def _get_test_backend():
    host = os.environ.get("CONTAO_TEST_HOST", "your-server.example.com")
    user = os.environ.get("CONTAO_TEST_USER", "ssh-username")
    root = os.environ.get("CONTAO_TEST_ROOT", "/var/www/contao")
...
class TestCLISubprocess:
    CLI_BASE = _resolve_cli("cli-anything-contao")
