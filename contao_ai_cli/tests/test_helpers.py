...
from contao_ai_cli.core.member import member_create
...
class TestRunSqlTable:
    def test_run_sql_table_returns_list(self):
        ...
        with patch("contao_ai_cli.core.contao_ops.parse_table", return_value=[{"id": "1", "title": "Foo"}]):
    ...
    def test_run_sql_table_returns_empty_list_on_no_rows(self):
        ...
        with patch("contao_ai_cli.core.contao_ops.parse_table", return_value=None):
